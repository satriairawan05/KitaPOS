...
**KitaPOS** adalah aplikasi **Point of Sales (POS)** berbasis web yang dirancang khusus untuk **restoran, kafe, dan usaha kuliner**. Dengan tampilan **responsif mobile-first** dan tema merah elegan, aplikasi ini membantu Anda mengelola transaksi penjualan dengan mudah, cepat, dan profesional.
...
### 1. 🍽️ Manajemen Menu
- Daftar menu dalam bentuk **card** dengan gambar atau emoji.
- **Filter Kategori**: Makanan, Minuman, Cemilan.
- **Pencarian real-time** berdasarkan nama menu.
- **Status Stok**: Tersedia (✅), Stok Menipis (⚠️), Habis (❌) dengan badge visual.
- **Tambah Menu Manual**:
  - Nama menu (wajib)
...
### 2. 🛒 Keranjang Belanja
- Sidebar di desktop, slide-down panel di mobile.
...
- **2 Metode Pembayaran**:
  ...
  - **📱 QRIS**: Total otomatis terisi, tanpa input manual.
...
- **Format ribuan otomatis**: `50000` → `50.000`, `100000` → `100.000`.
...
- Tersedia di navbar (desktop/mobile) dan floating button (mobile).
...
rresources/views/pos/index.blade.php # Ganti nama index.html
...
<a href="https://www.linkedin.com/in/satriairawan05_" target="_blank">
    <img src="https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white" alt="LinkedIn">
</a>

<a href="https://instagram.com/satriai418" target="_blank">
    <img src="https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white" alt="Instagram">
</a>

<a href="https://wa.me/082253332802" target="_blank">
